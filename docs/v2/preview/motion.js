...
(function () {
  ...
  window.MVOW_MOTION.openingHourglass = function openingHourglass(opts) {
    ...
    return new Promise(function (resolve) {
      ...
      stage.setAttribute('aria-label', 'FOCUS AI — sizning intizom do\'stingiz');
      ...
      glow.innerHTML = [
        '<svg viewBox="0 0 80 100" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">',
          '<path d="M14 8 H66 M14 92 H66" stroke="#6C5CE7" stroke-width="3" stroke-linecap="round"/>',
          '<path d="M18 8 L40 50 L18 92 Z" stroke="#6C5CE7" stroke-width="2.2" stroke-linejoin="round" fill="rgba(108, 92, 231,0.06)"/>',
          '<path d="M62 8 L40 50 L62 92 Z" stroke="#6C5CE7" stroke-width="2.2" stroke-linejoin="round" fill="rgba(108, 92, 231,0.06)"/>',
          '<circle cx="40" cy="50" r="1.6" fill="#6C5CE7"/>',
        '</svg>'
      ].join('');

  ...
  const DICT = {
    uz: {
      ...
      settings: {
        ...
        light_mode: "Yorug' rejim", reduce_motion: "Harakatni kamaytirish", reduce_motion_hint: "Animatsiya va effektlarni o'chiradi (tinch, tejamkor).", perm_screen_time_hint: "Boshqa ilovalarda qancha vaqt o'tkazganingizni ko'rish uchun.", perm_notification_hint: "Eslatma va vazifa vaqtida sizni ogohlantirish uchun.",
    ...
    ru: {
      ...
      settings: {
        ...
        light_mode: 'Светлая тема', reduce_motion: 'Меньше движения', reduce_motion_hint: 'Отключает анимации и эффекты (спокойно, экономно).', perm_screen_time_hint: 'Чтобы видеть, сколько времени вы проводите в других приложениях.', perm_notification_hint: 'Чтобы напоминать вам о задачах и времени.',
    ...
    en: {
      ...
      settings: {
        ...
        light_mode: 'Light mode', reduce_motion: 'Reduce motion', reduce_motion_hint: 'Turns off animations and effects (calm, battery-friendly).', perm_screen_time_hint: 'To see how much time you spend in other apps.', perm_notification_hint: 'To remind you at task and reminder times.',

  ...
  const DICT = {
    uz: {
      ...
      hisobot: {
        ...
        select_hint: "Belgilangan vazifalar do'st/ustoz/ota-onangizga ko'rinadi. Belgini oling — bekitiladi.", share_btn: 'Ulashish',
    ...
    ru: {
      ...
      hisobot: {
        ...
        select_hint: 'Отмеченные задачи видят друг/наставник/родитель. Снимите отметку — скроется.', share_btn: 'Поделиться',
    ...
    en: {
      ...
      hisobot: {
        ...
        select_hint: 'Checked tasks are visible to your friend/mentor/parent. Uncheck to hide.', share_btn: 'Share',

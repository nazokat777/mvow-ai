  ...
  const DICT = {
    uz: {
      ...
      settings: {
        ...
        sec_security: "Xavfsizlik", pin_lock_lbl: "PIN kod (o'rnatish / o'zgartirish)", applock_lbl: "Ochilganda butun ilovani qulflash", featlock_lbl: "Funksiyalarni alohida qulflash", pin_on: "Yoqilgan ✓", pin_off: "O'chiq ›",
    ...
    ru: {
      ...
      settings: {
        ...
        sec_security: 'Безопасность', pin_lock_lbl: 'PIN-код (задать / изменить)', applock_lbl: 'Блокировать всё приложение при открытии', featlock_lbl: 'Блокировать отдельные функции', pin_on: 'Включён ✓', pin_off: 'Выкл ›',
    ...
    en: {
      ...
      settings: {
        ...
        sec_security: 'Security', pin_lock_lbl: 'PIN code (set / change)', applock_lbl: 'Lock whole app on open', featlock_lbl: 'Lock individual features', pin_on: 'On ✓', pin_off: 'Off ›',

  ...
  const DICT = {
    uz: {
      ...
      hisobot: {
        ...
        select_hint: "Belgilangan vazifalar do'st/ustoz/ota-onangizga ko'rinadi. Belgini oling — bekitiladi.", share_btn: 'Ulashish', vis_title: "Do'st/ustozga ko'rinsin:", vis_hours: 'Fokus soati', vis_tasks: 'Vazifalar soni', vis_notimer: 'Taymerli / taymersiz belgisi', vis_note: "Berkitilgani ularga umuman ko'rinmaydi (telefoningizda qoladi).",
    ...
    ru: {
      ...
      hisobot: {
        ...
        select_hint: 'Отмеченные задачи видят друг/наставник/родитель. Снимите отметку — скроется.', share_btn: 'Поделиться', vis_title: 'Показывать другу/наставнику:', vis_hours: 'Часы фокуса', vis_tasks: 'Число задач', vis_notimer: 'Метка таймер/без таймера', vis_note: 'Скрытое им вообще не видно (остаётся на телефоне).',
    ...
    en: {
      ...
      hisobot: {
        ...
        select_hint: 'Checked tasks are visible to your friend/mentor/parent. Uncheck to hide.', share_btn: 'Share', vis_title: 'Show to friend/mentor:', vis_hours: 'Focus hours', vis_tasks: 'Task count', vis_notimer: 'Timer / no-timer badge', vis_note: 'Hidden ones are not visible to them at all (stays on your phone).',

  ...
  const DICT = {
    uz: {
      ...
      dostlar: {
        ...
        timer_badge: "taymerli", notimer_badge: "taymersiz", min_short: "daq",
        pv_tap: "do'stingiz nimani ko'radi",
        pv_head: "Do'st, ustoz va ota-onangiz shuni ko'radi",
        pv_focus: "Fokus vaqti",
        pv_habits: "Bajarilgan odatlar",
        pv_hidden: "berkitilgan",
      ...
      gallery: {
        ...
        sec_intro: "Tanishuv",
        sec_plan: "Reja", sec_settings: "Sozlama",
        sec_day: "Kun",
        sec_do: "Bajarish",
        sec_result: "Natija",
        s_intro: "Tanishuv",
      ...
      common: {
        ...
        save: 'Saqla',
        cancel: 'Bekor',
        undo: 'Bekor qilish', deleted: "O'chirildi",
        delete: "O'chir",
        back: 'Orqaga',
        menu: 'Mundarija',
      ...
      auth: {
        ...
        google_off: "Google ulanishni hozir bajarib bo'lmadi. Email bilan davom eting yoki \"Hozircha o'tkazib yuborish\".",
        or: 'yoki',
        email_lbl: 'Email',
      ...
      vada: {
        ...
        stamp: 'Tasdiqlandi', reread: "Va'dani qayta o'qish",
      ...
      maqsad: {
        ...
        dur_week: '1 hafta', dur_3day: '3 kun', dur_3day_sub: 'Tez sinov', step2_title_3day: '3 kunda nimaga erishasiz?',
        ...
        allow_overlap: "+ Shart qo'shish (baribir belgilash)",
        conflict_prefix: 'Bu vaqt band:', self_overlap: 'shu maqsad vaqtlari',
      ...
      maqsadlar: {
        ...
        restart_btn: '🔄 Hammasini qaytadan boshlash', restart_confirm: 'Aniqmisiz? Yana bosing', restart_done: 'Qaytadan boshlandi ✓', delete_all_btn: "🗑 Maqsadlarni o'chirish", delete_all_confirm: "Barcha maqsad o'chadi! Yana bosing", delete_all_done: "O'chirildi ✓",
      ...
      settings: {
        ...
        wake_time: 'Uyg\'onish vaqti', alarm_mode: 'Budilnik turi', alarm_simple: 'Oddiy', alarm_math: 'Matematik', alarm_mode_hint: "Oddiy — bir bosishda o'chadi. Matematik — 3 ta misolni yechmaguningizcha o'chmaydi.",
        ...
        logout: 'Chiqish', logout_confirm: 'Chiqasizmi? Bosing', restart: 'Ilovani qayta ishga tushirish', restart_hint: "Ilova sekin yoki noto'g'ri ishlasa bosing — keshni tozalab yangilaydi. Ma'lumotlaringiz saqlanadi.", restart_confirm: "Ilova yangilanib qayta yuklanadi. Ma'lumotlaringiz (maqsad, tarix, tanga) saqlanadi. Davom etamizmi?", restart_wait: 'Yangilanmoqda…',
        reset_confirm: 'Aniqmisiz? Bosing',
        reset_done: 'Tozalandi · qaytamiz',
        language: 'Til',
        sec_appearance: "Ko'rinish",
        light_mode: "Yorug' rejim", reduce_motion: "Harakatni kamaytirish", reduce_motion_hint: "Animatsiya va effektlarni o'chiradi (tinch, tejamkor).", perm_screen_time_hint: "Ilova qulflash bilan birga keladi (Play relizidan keyingi yangilanish).", perm_notification_hint: "Eslatma va vazifa vaqtida sizni ogohlantirish uchun.",
        ...
        sec_security: "Xavfsizlik", pin_lock_lbl: "PIN kod (o'rnatish / o'zgartirish)", applock_lbl: "Ochilganda butun ilovani qulflash", feat_hint: "Har funksiyani alohida qulflash / yashirish / nomlash — oʼsha funksiya sahifasidagi ⋮ tugmadan.", featlock_lbl: "Funksiyalar: berkitish / qulflash / nom", pin_on: "Yoqilgan ✓", pin_off: "O'chiq ›", sec_hidden: "Berkitilgan funksiyalar", restore: "Tiklash",
      ...
      alarm: {
        ...
        hint: 'javobni kiriting', simple_btn: "Uyg'ondim", title_simple: "Uyg'oning.",
        correct: "to'g'ri",
      ...
      hardlock: {
        ...
        bg_choose: 'Rasm',
        snd_off: 'Ovozsiz', snd_rain: "Yomg'ir", snd_ocean: 'Dengiz', snd_forest: "O'rmon",
        ...
        done_btn: 'Bajardim',
        choice_title: 'Qanday boshlaymiz?', choice_back: 'Orqaga', exit_keep: '‹ Chiqish (taymer ishlaydi)',
        ...
        opt_pomo: 'Pomodoro',
        opt_pomo_desc: '25 daq ish + 5 daq dam sikllari', recommended: 'Tavsiya', opt_10k: '🎯 10 000 soat', opt_10k_desc: "Mahorat yo'li — shu maqsad soatlari yig'iladi", sub_10k: '10 000 soat sari',
        timer_full: "{mins} daqiqa to'liq",
        pomo_summary: '{cycles} sikl · {total} daq jami',
        ask_title: 'Bajardingizmi?', vis_ask: "👥 Do'stingizga ko'rinsinmi?",
      ...
      celebrate: {
        ...
        cta: 'Keyingi hafta',
        stamp: '7 kun · tugadi',
        v_rewire: "Siz to'xtamadingiz", v_pathway: 'Bu endi odatingiz', v_identity: 'Bu — yangi siz', v_compound: "Har kun kuch qo'shdi",
        v_will: "O'zingizni yengdingiz", v_auto: 'Sabr natija berdi', v_dopamine: 'Intizom yutdi', v_consistency: 'Izchillik — kuchingiz',
        days_unit: 'kun',
        hours_unit: 'soat',
      ...
      uyqu: {
        title: "Uyqu nazorati", sub: "Uyqungizni kuzating — vaqtida yoting, tetik turing. Yaxshi uyqu — intizomning yarmi.",
        goal_lbl: "Maqsad vaqtlari", bed_lbl: "Yotish", wake_lbl: "Uyg'onish", target: "Maqsad",
        remind_lbl: "Yotish vaqti eslatmasi", remind_hint: "Belgilangan vaqtda 'yotish payti' eslatmasi", remind_text: "Yotish vaqti keldi. Ekranni yoping, tanangizga dam bering.",
        log_lbl: "Kechagi uyquni belgilash", log_bed: "Nechada yotdingiz?", log_wake: "Nechada uyg'ondingiz?", save: "+ Saqlash",
        ai_title: "AI murabbiy — uyqu maslahati", ai_btn: "💬 Uyqum haqida maslahat ber", ai_loading: "O'ylayapman…",
        history: "Tarix", avg: "O'rtacha", empty: "Hali yozuv yo'q. Kechagi uyquni belgilang.", h: "s", m: "d",
        a_short: "Kam uxladingiz", a_ok: "Yetarli emas", a_good: "Zo'r uyqu 👍", a_long: "Biroz ko'p",
        cons_title: "Nega vaqtida yotish muhim",
        cons1: "Kam uyqu diqqat, xotira va qaror qabul qilishni pasaytiradi.",
        cons2: "Muntazam kech yotish kayfiyat, sabr va irodani zaiflashtiradi.",
        cons3: "Uyqusizlik energiya va sport natijalarini tushiradi.",
        cons4: "Yetarli uyqu esa ertalabki tetiklik va intizomni osonlashtiradi.",
        fb_short: "Keyingi kunlarda kam uxlayapsiz. Bugun maqsad vaqtida yoting — ertaga diqqatingiz sezilarli yaxshi bo'ladi.",
        fb_long: "Uyquingiz uzun — bu ham holsizlantiradi. Muntazam bir vaqtda yotib-turishga harakat qiling.",
        fb_ok: "Uyqu — intizomning poydevori. Har kuni bir vaqtda yoting, ekranni yarim soat oldin yoping — tetik turasiz."
      },
      mukofot: {
      ...
      wallet: {
        ...
        split_lbl: "Necha muddatga bo'lib", unit_week: "Hafta", unit_day: "Kun", per_day: "kuniga", days_short: "kun", today: "Bugun", avg_day: "kuniga o'rtacha",
        date_lbl: "Sana", date_exp_lbl: "Qachon kutilmoqda", date_start_lbl: "Boshlanish sanasi",
        clear_all: "Hammasini tozalash", clear_confirm: "Barcha hamyon yozuvlari o'chirilsinmi?",
        edit: "Tahrirlash", approx_lbl: "≈ Balansdan taxminan ayirilsin (rangsiz)",
        type_in: "Kirim", type_expected: "Kutilayotgan", type_exp: "Rasxod", type_plan: "Reja",
        history: "Tarix", hist_empty: "Hali tarix yo'q — har oy oxirida shu yerga saqlanadi", month_reset: "Yangi oy boshlandi — o'tgan oy Tarixga saqlandi",
        next_title: "Kelasi oy rejasi", next_note: "Kelayotgan oyga kirim va rasxodni oldindan rejalashtiring. Yangi oy boshlanganda «Ijroga o'tkazish» bilan ular shu oyning kutilayotgan kirimi va rejasiga aylanadi.", next_in_hd: "Kutilayotgan kirim", next_exp_hd: "Rejalangan rasxod", next_add_in: "+ Kirim", next_add_exp: "+ Rasxod", next_activate: "Yangi oyda ijroga o'tkazish", next_empty_in: "Hali yo'q", next_empty_exp: "Hali yo'q", next_confirm: "Kelasi oy rejasi shu oyning kutilayotgan kirimi va rejasiga o'tkazilsinmi?", next_done: "Reja ijroga o'tkazildi ✓", next_ready: "Yangi oy boshlandi — kelasi oy rejangizni «Ijroga o'tkazish» bilan qo'llang",
      ...
      menu: {
        sub_count: 'ekran', sub_tagline: "sizning intizom do'stingiz",
        sec_intro: 'Tanishuv',
        sec_plan: 'Reja', sec_settings: 'Sozlama',
        sec_day: 'Kun',
        sec_do: 'Bajarish',
    ...
    ru: {
      ...
      dostlar: {
        ...
        timer_badge: "с таймером", notimer_badge: "без таймера", min_short: "мин",
        pv_tap: "что видит Ваш друг",
        pv_head: "Друг, наставник и родители видят это",
        pv_focus: "Время фокуса",
        pv_habits: "Выполнено привычек",
        pv_hidden: "скрыто",
      ...
      gallery: {
        ...
        sec_plan: "План", sec_settings: "Настройки",
        sec_day: "День",
        sec_do: "Выполнение",
      ...
      auth: {
        ...
        google_off: 'Не удалось подключиться через Google. Продолжите по email или нажмите «Пока пропустить».',
        or: 'или',
        email_lbl: 'Email',
      ...
      vada: {
        ...
        stamp: 'Подтверждено', reread: 'Перечитать обещание',
      ...
      maqsad: {
        ...
        dur_week: '1 неделя', dur_3day: '3 дня', dur_3day_sub: 'Быстрая проверка', step2_title_3day: 'Чего достигнете за 3 дня?',
        ...
        allow_overlap: '+ Добавить условие (отметить всё равно)',
        conflict_prefix: 'Это время занято:', self_overlap: 'время этой же цели',
      ...
      maqsadlar: {
        ...
        add_btn: 'Новая цель',
        restart_btn: '🔄 Начать все заново', restart_confirm: 'Уверены? Нажмите ещё раз', restart_done: 'Начато заново ✓', delete_all_btn: '🗑 Удалить цели', delete_all_confirm: 'Все цели удалятся! Нажмите ещё раз', delete_all_done: 'Удалено ✓',
      ...
      settings: {
        ...
        wake_time: 'Время пробуждения', alarm_mode: 'Тип будильника', alarm_simple: 'Обычный', alarm_math: 'Математический', alarm_mode_hint: 'Обычный — выключается одним нажатием. Математический — не выключится, пока не решите 3 примера.',
        auto_next: 'Авто-продолжение',
        voice_remind: 'Голосовое напоминание',
        negotiation: 'Тест внимания',
        about_link: 'О приложении',
        reset: 'Очистить всё',
        logout: 'Выйти', logout_confirm: 'Выйти? Нажмите', restart: 'Перезапустить приложение', restart_hint: 'Нажмите, если приложение работает медленно или неверно — очистит кэш и обновит. Ваши данные сохранятся.', restart_confirm: 'Приложение обновится и перезагрузится. Ваши данные (цели, история, монеты) сохранятся. Продолжить?', restart_wait: 'Обновление…',
        reset_confirm: 'Уверены? Нажмите',
        reset_done: 'Очищено · возвращаемся',
        language: 'Язык',
        sec_appearance: 'Внешний вид',
        light_mode: 'Светлая тема', reduce_motion: 'Меньше движения', reduce_motion_hint: 'Отключает анимации и эффекты (спокойно, экономно).', perm_screen_time_hint: 'Появится вместе с блокировкой приложений (обновление после релиза в Play).', perm_notification_hint: 'Чтобы напоминать вам о задачах и времени.',
        ...
        sec_security: 'Безопасность', pin_lock_lbl: 'PIN-код (задать / изменить)', applock_lbl: 'Блокировать всё приложение при открытии', feat_hint: 'Блокировка / скрытие / имя каждой функции — через кнопку ⋮ на странице самой функции.', featlock_lbl: 'Функции: скрыть / блокировать / имя', pin_on: 'Включён ✓', pin_off: 'Выкл ›', sec_hidden: 'Скрытые функции', restore: 'Вернуть',
      ...
      alarm: {
        ...
        hint: 'введите ответ', simple_btn: 'Я проснулся', title_simple: 'Просыпайтесь.',
        correct: 'верно',
        wrong: 'неверно · новый',
      ...
      hardlock: {
        ...
        bg_choose: 'Фото',
        snd_off: 'Без звука', snd_rain: 'Дождь', snd_ocean: 'Море', snd_forest: 'Лес',
        bg_remove: 'Убрать',
        bg_shuffle: 'Другое',
        bg_off: 'Без фона',
        bg_on: 'Фон',
        ...
        done_btn: 'Готово',
        choice_title: 'Как начнём?', choice_back: 'Назад', exit_keep: '‹ Выйти (таймер идёт)',
        ...
        opt_pomo: 'Pomodoro',
        opt_pomo_desc: 'Циклы: 25 мин работа + 5 мин отдых', recommended: 'Рекомендуем', opt_10k: '🎯 10 000 часов', opt_10k_desc: 'Путь к мастерству — часы этой цели суммируются', sub_10k: 'к 10 000 часам',
        timer_full: '{mins} минут полностью',
        pomo_summary: '{cycles} цикл(ов) · {total} мин всего',
        ask_title: 'Выполнили?', vis_ask: '👥 Показать другу/наставнику?',
      ...
      celebrate: {
        ...
        v_rewire: 'Вы не остановились', v_pathway: 'Теперь это ваша привычка', v_identity: 'Это — новый вы', v_compound: 'Каждый день добавлял силы',
        v_will: 'Вы победили себя', v_auto: 'Терпение дало результат', v_dopamine: 'Дисциплина победила', v_consistency: 'Постоянство — ваша сила',
      ...
      uyqu: {
        title: "Контроль сна", sub: "Следите за сном — ложитесь вовремя, будьте бодры. Хороший сон — половина дисциплины.",
        goal_lbl: "Целевое время", bed_lbl: "Отбой", wake_lbl: "Подъём", target: "Цель",
        remind_lbl: "Напоминание об отбое", remind_hint: "В заданное время напомним лечь спать", remind_text: "Пора спать. Отложите экран, дайте телу отдохнуть.",
        log_lbl: "Отметить вчерашний сон", log_bed: "Во сколько легли?", log_wake: "Во сколько встали?", save: "+ Сохранить",
        ai_title: "AI-наставник — совет по сну", ai_btn: "💬 Совет по моему сну", ai_loading: "Думаю…",
        history: "История", avg: "В среднем", empty: "Записей пока нет. Отметьте вчерашний сон.", h: "ч", m: "м",
        a_short: "Мало спали", a_ok: "Недостаточно", a_good: "Отличный сон 👍", a_long: "Многовато",
        cons_title: "Почему важно ложиться вовремя",
        cons1: "Недосып снижает внимание, память и принятие решений.",
        cons2: "Регулярный поздний сон ослабляет настроение, терпение и волю.",
        cons3: "Недосыпание снижает энергию и спортивные результаты.",
        cons4: "А достаточный сон даёт утреннюю бодрость и облегчает дисциплину.",
        fb_short: "Последние дни вы мало спите. Лягте вовремя сегодня — завтра внимание будет заметно лучше.",
        fb_long: "Сон долгий — это тоже утомляет. Старайтесь ложиться и вставать в одно время.",
        fb_ok: "Сон — фундамент дисциплины. Ложитесь в одно время, отложите экран за полчаса — будете бодры."
      },
      mukofot: {
      ...
      wallet: {
        ...
        split_lbl: "На сколько периодов", unit_week: "Недели", unit_day: "Дни", per_day: "в день", days_short: "дн.", today: "Сегодня", avg_day: "в среднем в день",
        date_lbl: "Дата", date_exp_lbl: "Когда ожидается", date_start_lbl: "Дата начала",
        clear_all: "Очистить всё", clear_confirm: "Удалить все записи кошелька?",
        edit: "Редактировать", approx_lbl: "≈ Примерно вычесть из баланса (без цвета)",
        type_in: "Доход", type_expected: "Ожидается", type_exp: "Расход", type_plan: "План",
        history: "История", hist_empty: "Истории пока нет — сохраняется в конце каждого месяца", month_reset: "Начался новый месяц — прошлый сохранён в Историю",
        next_title: "План на следующий месяц", next_note: "Заранее спланируйте доход и расходы на будущий месяц. Когда начнётся новый месяц, кнопкой «Активировать» они станут ожидаемым доходом и планом этого месяца.", next_in_hd: "Ожидаемый доход", next_exp_hd: "Планируемый расход", next_add_in: "+ Доход", next_add_exp: "+ Расход", next_activate: "Активировать в новом месяце", next_empty_in: "Пока нет", next_empty_exp: "Пока нет", next_confirm: "Перенести план следующего месяца в ожидаемый доход и план этого месяца?", next_done: "План активирован ✓", next_ready: "Начался новый месяц — активируйте план кнопкой «Активировать»",
      ...
      menu: {
        sub_count: 'экранов', sub_tagline: 'ваш друг дисциплины',
        sec_intro: 'Знакомство',
        sec_plan: 'План', sec_settings: 'Настройки',
        sec_day: 'День',
        sec_do: 'Выполнение',
    ...
    en: {
      ...
      dostlar: {
        ...
        timer_badge: "timed", notimer_badge: "untimed", min_short: "min",
        pv_tap: "what your friend sees",
        pv_head: "Your friend, mentor and parents see this",
        pv_focus: "Focus time",
        pv_habits: "Habits done",
        pv_hidden: "hidden",
      ...
      gallery: {
        ...
        sec_intro: "Intro",
        sec_plan: "Plan", sec_settings: "Settings",
        sec_day: "Day",
        sec_do: "Doing",
        sec_result: "Result",
        s_intro: "Intro",
      ...
      auth: {
        ...
        google_off: 'Couldn\'t connect with Google right now. Continue with email, or tap "Skip for now".',
        or: 'or',
        email_lbl: 'Email',
      ...
      vada: {
        ...
        stamp: 'Confirmed', reread: 'Re-read the vow',
      ...
      maqsad: {
        ...
        dur_week: '1 week', dur_3day: '3 days', dur_3day_sub: 'Quick test', step2_title_3day: 'What will you achieve in 3 days?',
        ...
        allow_overlap: '+ Add anyway (schedule both)',
        conflict_prefix: 'This time is taken:', self_overlap: "this goal's own times",
      ...
      maqsadlar: {
        ...
        add_btn: 'New goal',
        restart_btn: '🔄 Restart all', restart_confirm: 'Sure? Tap again', restart_done: 'Restarted ✓', delete_all_btn: '🗑 Delete goals', delete_all_confirm: 'All goals will be deleted! Tap again', delete_all_done: 'Deleted ✓',
      ...
      settings: {
        ...
        wake_time: 'Wake time', alarm_mode: 'Alarm type', alarm_simple: 'Simple', alarm_math: 'Math', alarm_mode_hint: 'Simple — dismiss with one tap. Math — will not stop until you solve 3 problems.',
        auto_next: 'Auto-continue',
        voice_remind: 'Voice reminder',
        negotiation: 'Attention test',
        about_link: 'About this app',
        reset: 'Clear everything',
        logout: 'Log out', logout_confirm: 'Log out? Tap', restart: 'Restart the app', restart_hint: 'Tap if the app runs slow or wrong — it clears the cache and refreshes. Your data is kept.', restart_confirm: 'The app will refresh and reload. Your data (goals, history, coins) is kept. Continue?', restart_wait: 'Refreshing…',
        reset_confirm: 'Sure? Tap',
        reset_done: 'Cleared · going back',
        language: 'Language',
        sec_appearance: 'Appearance',
        light_mode: 'Light mode', reduce_motion: 'Reduce motion', reduce_motion_hint: 'Turns off animations and effects (calm, battery-friendly).', perm_screen_time_hint: 'Arrives with app locking (an update after the Play release).', perm_notification_hint: 'To remind you at task and reminder times.',
        ...
        sec_security: 'Security', pin_lock_lbl: 'PIN code (set / change)', applock_lbl: 'Lock whole app on open', feat_hint: 'Lock / hide / rename each feature — via the ⋮ button on that feature page.', featlock_lbl: 'Features: hide / lock / rename', pin_on: 'On ✓', pin_off: 'Off ›', sec_hidden: 'Hidden features', restore: 'Restore',
      ...
      alarm: {
        ...
        hint: 'enter the answer', simple_btn: 'I am awake', title_simple: 'Wake up.',
        correct: 'correct',
        wrong: 'wrong · new one',
      ...
      home: {
        ...
        identity_with_goal: 'You\'ve kept «{goal}» going for a {streak}.',
        identity_plain: 'You\'ve been on the discipline path for a {streak}.',
      ...
      hardlock: {
        ...
        ind_done: 'Focus done',
        bg_choose: 'Photo',
        snd_off: 'No sound', snd_rain: 'Rain', snd_ocean: 'Ocean', snd_forest: 'Forest',
        bg_remove: 'Remove',
        bg_shuffle: 'Another',
        ...
        done_btn: 'Done',
        choice_title: 'How shall we start?', choice_back: 'Back', exit_keep: '‹ Exit (timer keeps running)',
        ...
        opt_pomo: 'Pomodoro',
        opt_pomo_desc: '25-min work + 5-min break cycles', recommended: 'Recommended', opt_10k: '🎯 10,000 hours', opt_10k_desc: "Path to mastery — this goal's hours add up", sub_10k: 'toward 10,000 hours',
        timer_full: '{mins} minutes total',
        pomo_summary: '{cycles} cycles · {total} min total',
        ask_title: 'Did you complete it?', vis_ask: '👥 Show to your friend/mentor?',
      ...
      celebrate: {
        ...
        cta: 'Next week',
        v_rewire: "You didn't stop", v_pathway: 'This is your habit now', v_identity: 'This is the new you', v_compound: 'Every day added strength',
        v_will: 'You mastered yourself', v_auto: 'Patience paid off', v_dopamine: 'Discipline won', v_consistency: 'Consistency is your strength',
      ...
      uyqu: {
        title: "Sleep tracker", sub: "Track your sleep — go to bed on time, stay sharp. Good sleep is half of discipline.",
        goal_lbl: "Target times", bed_lbl: "Bedtime", wake_lbl: "Wake", target: "Target",
        remind_lbl: "Bedtime reminder", remind_hint: "A 'time to sleep' reminder at the set time", remind_text: "Time to sleep. Put the screen away and let your body rest.",
        log_lbl: "Log last night's sleep", log_bed: "When did you go to bed?", log_wake: "When did you wake up?", save: "+ Save",
        ai_title: "AI coach — sleep advice", ai_btn: "💬 Advise me on my sleep", ai_loading: "Thinking…",
        history: "History", avg: "Average", empty: "No entries yet. Log last night's sleep.", h: "h", m: "m",
        a_short: "Too little sleep", a_ok: "Not enough", a_good: "Great sleep 👍", a_long: "A bit much",
        cons_title: "Why sleeping on time matters",
        cons1: "Too little sleep lowers focus, memory and decision-making.",
        cons2: "Regular late nights weaken mood, patience and willpower.",
        cons3: "Sleep deprivation drops energy and athletic results.",
        cons4: "Enough sleep makes morning alertness and discipline easier.",
        fb_short: "You've slept little lately. Go to bed on time tonight — tomorrow your focus will be noticeably better.",
        fb_long: "Your sleep is long — that also tires you. Try to sleep and wake at the same time.",
        fb_ok: "Sleep is the foundation of discipline. Sleep at the same time, put the screen away half an hour before — you'll stay sharp."
      },
      mukofot: {
      ...
      wallet: {
        ...
        split_lbl: "Split over", unit_week: "Weeks", unit_day: "Days", per_day: "per day", days_short: "d", today: "Today", avg_day: "avg/day",
        date_lbl: "Date", date_exp_lbl: "When expected", date_start_lbl: "Start date",
        clear_all: "Clear all", clear_confirm: "Delete all wallet entries?",
        edit: "Edit", approx_lbl: "≈ Approximately deduct (muted)",
        type_in: "Income", type_expected: "Expected", type_exp: "Expense", type_plan: "Plan",
        history: "History", hist_empty: "No history yet — saved at each month's end", month_reset: "New month started — last month saved to History",
        next_title: "Next month plan", next_note: "Plan income and expenses for the upcoming month in advance. When the new month begins, tap «Activate» and they become this month's expected income and plan.", next_in_hd: "Expected income", next_exp_hd: "Planned expense", next_add_in: "+ Income", next_add_exp: "+ Expense", next_activate: "Activate in new month", next_empty_in: "None yet", next_empty_exp: "None yet", next_confirm: "Move next month's plan into this month's expected income and plan?", next_done: "Plan activated ✓", next_ready: "New month started — activate your next-month plan with «Activate»",
      ...
      menu: {
        sub_count: 'screens', sub_tagline: 'your discipline friend',
        sec_intro: 'Intro',
        sec_plan: 'Plan', sec_settings: 'Settings',
        sec_day: 'Day',
        sec_do: 'Doing',

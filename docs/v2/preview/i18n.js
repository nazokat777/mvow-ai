  ...
  const DICT = {
    uz: {
      ...
      hardlock: {
        ...
        opt_pomo: 'Pomodoro',
        opt_pomo_desc: '25 daq ish + 5 daq dam sikllari', recommended: 'Tavsiya', opt_10k: '🎯 10 000 soat', opt_10k_desc: "Mahorat yo'li — jami soatlaringiz yig'iladi", sub_10k: '10 000 soat sari',
    ...
    ru: {
      ...
      hardlock: {
        ...
        opt_pomo: 'Pomodoro',
        opt_pomo_desc: 'Циклы: 25 мин работа + 5 мин отдых', recommended: 'Рекомендуем', opt_10k: '🎯 10 000 часов', opt_10k_desc: 'Путь к мастерству — часы суммируются', sub_10k: 'к 10 000 часам',
    ...
    en: {
      ...
      hardlock: {
        ...
        opt_pomo: 'Pomodoro',
        opt_pomo_desc: '25-min work + 5-min break cycles', recommended: 'Recommended', opt_10k: '🎯 10,000 hours', opt_10k_desc: 'Path to mastery — your hours add up', sub_10k: 'toward 10,000 hours',

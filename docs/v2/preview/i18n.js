  ...
  const DICT = {
    uz: {
      ...
      celebrate: {
        ...
        cta: 'Keyingi hafta',
        stamp: '7 kun · tugadi',
        v_rewire: 'Miyangiz qayta simlandi', v_pathway: "Yangi neyron yo'li", v_identity: "Siz — o'sha odamsiz", v_compound: 'Har kuni 1% — birikadi',
        v_will: 'Iroda muskuli kuchaydi', v_auto: 'Avtomatizm boshlandi', v_dopamine: 'Intizom > dofamin', v_consistency: "Izchillik — ustunligingiz",
        days_unit: 'kun',
        hours_unit: 'soat',
    ...
    ru: {
      ...
      celebrate: {
        ...
        v_rewire: 'Мозг перестроился', v_pathway: 'Новый нейронный путь', v_identity: 'Вы — тот самый человек', v_compound: 'Каждый день +1% — копится',
        v_will: 'Мышца воли окрепла', v_auto: 'Автоматизм запущен', v_dopamine: 'Дисциплина > дофамин', v_consistency: 'Последовательность — ваше преимущество',
    ...
    en: {
      ...
      celebrate: {
        ...
        cta: 'Next week',
        v_rewire: 'Your brain rewired', v_pathway: 'New neural pathway', v_identity: 'You are that person now', v_compound: '1% a day compounds',
        v_will: 'Willpower got stronger', v_auto: 'Automaticity begins', v_dopamine: 'Discipline > dopamine', v_consistency: 'Consistency is your edge',

  ...
  const DICT = {
    uz: {
      ...
      celebrate: {
        ...
        cta: 'Keyingi hafta',
        stamp: '7 kun · tugadi',
        v_tog: "Cho'qqiga chiqdingiz", v_daryo: "Daryodan o'tdingiz", v_nur: 'Nur ustuni qad rostladi', v_tong: 'Yangi tong otdi',
        v_ochoq: "O'choq alangalandi", v_langar: 'Langaringiz mustahkam', v_koprik: "Ko'prik qurildi", v_hosil: "Hosil yig'ildi",
        days_unit: 'kun',
        hours_unit: 'soat',
    ...
    ru: {
      ...
      celebrate: {
        ...
        v_tog: 'Вы взошли на вершину', v_daryo: 'Вы перешли реку', v_nur: 'Столб света поднялся', v_tong: 'Взошла новая заря',
        v_ochoq: 'Горн разгорелся', v_langar: 'Ваш якорь крепок', v_koprik: 'Мост построен', v_hosil: 'Урожай собран',
    ...
    en: {
      ...
      celebrate: {
        ...
        cta: 'Next week',
        v_tog: 'You reached the summit', v_daryo: 'You crossed the river', v_nur: 'A pillar of light rose', v_tong: 'A new dawn broke',
        v_ochoq: 'The forge is lit', v_langar: 'Your anchor holds', v_koprik: 'The bridge is built', v_hosil: 'The harvest is in',
